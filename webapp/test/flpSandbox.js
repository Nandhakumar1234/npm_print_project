		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "reusableprint",
									"targetURL": "#commoboprintreusableeprint-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commoboprintreusableeprint-display": {
								"semanticObject": "commoboprintreusableeprint",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mobo.printreusablee.print",
									"url": sap.ui.require.toUrl("com/mobo/printreusablee/print")
								}
							}
						}
					}
